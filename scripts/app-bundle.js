...
define('main',['exports', './environment'], function (exports, _environment) {
  ...
  function configure(aurelia) {
    ...
    aurelia.start().then(function () {
      return aurelia.setRoot('components/app');
    });
  }
});
define('components/app',['exports'], function (exports) {
  'use strict';
...
define('event/messages',["exports"], function (exports) {
    "use strict";
...
define('helpers/utility',["exports"], function (exports) {
	"use strict";
...
define('helpers/web-api',['exports'], function (exports) {
  'use strict';
...
define('resources/value-converters/phone-number',["exports"], function (exports) {
  ...
  var PhoneNumberValueConverter = exports.PhoneNumberValueConverter = function () {
    ...
    PhoneNumberValueConverter.prototype.toView = function toView(value, separator) {
...
define('components/contact/create/create',['exports'], function (exports) {
    'use strict';
    ...
    var Create = exports.Create = function Create() {
        ...
        this.message = 'Create Page.';
    };
});
define('components/contact/detail/detail',['exports', 'aurelia-event-aggregator', '../../../event/messages', '../../../helpers/web-api', '../../../helpers/utility'], function (exports, _aureliaEventAggregator, _messages, _webApi, _utility) {
    'use strict';
...
define('components/contact/home/home',['exports'], function (exports) {
    'use strict';
...
define('components/contact/list/list',['exports', '../../../helpers/web-api', 'aurelia-event-aggregator', '../../../event/messages'], function (exports, _webApi, _aureliaEventAggregator, _messages) {
    'use strict';
    ...
    var ContactList = exports.ContactList = function () {
        ...
        function ContactList(api, ea) {
            ...
            this.ea.subscribe(_messages.ContactViewed, function (msg) {
                return _this.select(msg.contact);
            });
            this.ea.subscribe(_messages.ContactUpdated, function (msg) {
...
define('components/contact/profile/profile',['exports'], function (exports) {
    'use strict';
    ...
    var Profile = exports.Profile = function () {
        ...
        Profile.prototype.configureRouter = function configureRouter(config, router) {
            config.map([{
                route: '',
                name: 'User List',
...
define('resources/elements/header/header',['exports', 'aurelia-framework', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaRouter) {
  'use strict';
  ...
  var Header = exports.Header = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router), _dec(_class = function Header(router) {
    _classCallCheck(this, Header);

    this.router = router;
  }) || _class);
});
define('resources/elements/forms/create-user/create-user',['exports', 'aurelia-event-aggregator', 'aurelia-framework', 'aurelia-validation'], function (exports, _aureliaEventAggregator, _aureliaFramework, _aureliaValidation) {
  'use strict';
  ...
  var CreateUser = exports.CreateUser = (_dec = (0, _aureliaFramework.inject)(_aureliaFramework.NewInstance.of(_aureliaValidation.ValidationController)), _dec(_class = function () {
    function CreateUser(validationController) {
    ...
    CreateUser.prototype.formSubmit = function formSubmit() {
      console.log('submit');
    };
...
define('resources/elements/forms/registration/registration',['exports', 'aurelia-dependency-injection', 'aurelia-validation'], function (exports, _aureliaDependencyInjection, _aureliaValidation) {
    'use strict';
    ...
    var Registration = exports.Registration = (_dec = (0, _aureliaDependencyInjection.inject)(_aureliaDependencyInjection.NewInstance.of(_aureliaValidation.ValidationController)), _dec(_class = function () {
        function Registration(controller) {
        ...
        Registration.prototype.submit = function submit() {
            this.controller.validate().then(function (res) {
                console.info(res);
            }).catch(function (e) {
                console.log(e);
            });
    ...
    _aureliaValidation.ValidationRules.ensure('email').required().on(Registration);
});
...
define('text!components/app.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.css\"></require><require from=\"../styles.css\"></require><require from=\"../resources/elements/header/header\"></require><header></header><div class=\"container\"><div class=\"row\"><router-view></router-view></div></div></template>"; });
define('text!components/contact/create/create.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../resources/elements/forms/create-user/create-user\"></require><h1>${message}</h1><div class=\"panel panel-primary\"><div class=\"panel-heading\"><h3 class=\"panel-title\">Create User</h3></div><div class=\"panel-body\"><create-user></create-user></div></div></template>"; });
define('text!components/contact/detail/detail.html', ['module'], function(module) { module.exports = "<template><h1>${message}</h1><div class=\"panel panel-primary\"><div class=\"panel-heading\"><h3 class=\"panel-title\">Profile</h3></div><div class=\"panel-body\"><form role=\"form\" class=\"form-horizontal\"><div class=\"form-group\"><label class=\"col-sm-2 control-label\">First Name</label><div class=\"col-sm-10\"><input type=\"text\" placeholder=\"first name\" class=\"form-control\" value.bind=\"contact.firstName\"></div></div><div class=\"form-group\"><label class=\"col-sm-2 control-label\">Last Name</label><div class=\"col-sm-10\"><input type=\"text\" placeholder=\"last name\" class=\"form-control\" value.bind=\"contact.lastName\"></div></div><div class=\"form-group\"><label class=\"col-sm-2 control-label\">Email</label><div class=\"col-sm-10\"><input type=\"text\" placeholder=\"email\" class=\"form-control\" value.bind=\"contact.email\"></div></div><div class=\"form-group\"><label class=\"col-sm-2 control-label\">Phone Number</label><div class=\"col-sm-10\"><input type=\"text\" placeholder=\"phone number\" class=\"form-control\" value.bind=\"contact.phoneNumber\"></div></div></form></div></div><div class=\"button-bar\"><button class=\"btn btn-success\" click.delegate=\"save()\" disabled.bind=\"!canSave\">Save</button></div></template>"; });
define('text!components/contact/home/home.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../resources/elements/forms/registration/registration\"></require><h1>${message}</h1><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis deserunt, fuga illo iste minima necessitatibus neque provident quam rem repudiandae! Eveniet laboriosam optio perspiciatis veniam voluptas! Eaque eius iste possimus?</p><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis deserunt, fuga illo iste minima necessitatibus neque provident quam rem repudiandae! Eveniet laboriosam optio perspiciatis veniam voluptas! Eaque eius iste possimus?</p><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis deserunt, fuga illo iste minima necessitatibus neque provident quam rem repudiandae! Eveniet laboriosam optio perspiciatis veniam voluptas! Eaque eius iste possimus?</p><registration></registration></template>"; });
define('text!components/contact/list/list.html', ['module'], function(module) { module.exports = "<template><h1>${message}</h1><div class=\"contact-list\"><ul class=\"list-group\"><li repeat.for=\"contact of contacts\" class=\"list-group-item ${contact.id === $parent.selectedId ? 'active' : ''}\"><a route-href=\"route: Contact; params.bind: {id: contact.id}\" click.delegate=\"$parent.select(contact)\"><h4 class=\"list-group-item-heading\">${contact.firstName} ${contact.lastName}</h4><p class=\"list-group-item-texy\">${contact.email}</p></a></li></ul></div></template>"; });
define('text!components/contact/profile/profile.html', ['module'], function(module) { module.exports = "<template><router-view></router-view></template>"; });
define('text!resources/elements/header/header.html', ['module'], function(module) { module.exports = "<template><nav class=\"navbar navbar-inverse\"><div class=\"container-fluid\"><div class=\"navbar-header\"><a class=\"navbar-brand\" route-href=\"route: Home\">Brand</a></div><div class=\"collapse navbar-collapse\"><ul class=\"nav navbar-nav\"><li repeat.for=\"row of router.navigation\" class=\"${row.isActive ? 'active' : ''}\"><a href.bind=\"row.href\">${row.config.name}</a></li></ul></div></div></nav></template>"; });
define('text!resources/elements/forms/create-user/create-user.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../value-converters/phone-number\"></require><form role=\"form\" submit.trigger=\"formSubmit()\"><div class=\"form-group\"><label for=\"firstName\">First Name</label><input type=\"text\" value.bind=\"user.firstName\" class=\"form-control\" id=\"firstName\" placeholder=\"Enter First Name\"></div><div class=\"form-group\"><label for=\"lastName\">Last Name</label><input type=\"text\" value.bind=\"user.lastName\" class=\"form-control\" id=\"lastName\" placeholder=\"Enter Last Name\"></div><div class=\"form-group\"><label for=\"email\">Email</label><input type=\"text\" value.bind=\"user.email\" class=\"form-control\" id=\"email\" placeholder=\"Enter Email\"></div><div class=\"form-group\"><label for=\"phone\">Phone Number</label><input type=\"email\" value.bind=\"user.phone | phoneNumber:'-'\" class=\"form-control\" id=\"phone\" placeholder=\"Enter Phone Number\"></div><button type=\"submit\" class=\"btn btn-primary\">Submit</button></form></template>"; });
define('text!resources/elements/forms/registration/registration.html', ['module'], function(module) { module.exports = "<template><h3>Registration</h3><form submit.delegate=\"submit()\"><div class=\"form-group\"><label class=\"control-label\" for=\"first\">First Name</label><input type=\"text\" class=\"form-control\" id=\"first\" placeholder=\"First Name\" value.bind=\"firstName\"></div><div class=\"form-group\"><label class=\"control-label\" for=\"last\">Last Name</label><input type=\"text\" class=\"form-control\" id=\"last\" placeholder=\"Last Name\" value.bind=\"lastName\"></div><div class=\"form-group\"><label class=\"control-label\" for=\"email\">Email</label><input type=\"text\" class=\"form-control\" id=\"email\" placeholder=\"Email\" value.bind=\"email & validate\"></div><button type=\"submit\" class=\"btn btn-primary\">Submit</button></form></template>"; });
